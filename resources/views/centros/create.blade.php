      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="row form-group">
              <label for="select_institucion" class="col-sm-1 control-label">Institución</label>
              <div class="col-sm-4">
                <select class="form-control" id= "select_institucion"></select>
              </div>
            </div>
    ...
    <div class="modal modal-primary" id="myModal" >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header"><h4 class="modal-title">Nuevo Centro</h4></div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR)
        {
          ...
          $.each(data, function(i, value) {
            $('#select_institucion').append("<option value='" + value['id'] + "'>" + value['nombre'] + "</option>");
          });
        },
    ...
    $("#guardar").click(function() {
      var myObj = {};
      myObj["id_institucion"] = $("#select_institucion").val();
      ...
      $.ajax({
          ...
          success: function(data, textStatus, jqXHR)
          {
              ...
              $('div.modal-body').text("El centro " + $("#txt_nombre").val() + " se guardó correctamente");
              $('#btnTrigger').click();
          },
          error: function (jqXHR, textStatus, errorThrown)
          {
